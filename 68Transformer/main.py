...
class PositionWiseFFN(nn.Module):
    ...
    def __init__(self, ffn_num_input, ffn_num_hiddens, ffn_num_outputs,
        ...
        print('PositionWiseFFN self.dense1', self.dense1)
        self.relu = nn.ReLU()
        self.dense2 = nn.Linear(ffn_num_hiddens, ffn_num_outputs)
        print('PositionWiseFFN self.dense2', self.dense2)
...
# ffn.eval()
# print('ffn(torch.ones((2, 3, 4))):', ffn(torch.ones((2, 3, 4))))
...
# add_norm.eval()
# print('add_norm(torch.ones((2, 3, 4)):', add_norm(torch.ones((2, 3, 4))))
